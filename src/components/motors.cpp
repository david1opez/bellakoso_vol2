...
pros::Motor Right_Front_Wheel(RFWM_PORT, pros::E_MOTOR_GEARSET_18, true, pros::E_MOTOR_ENCODER_DEGREES); // Right Front Wheel Motor
pros::Motor Right_Back_Top_Wheel(RBTWM_PORT, pros::E_MOTOR_GEARSET_18, false, pros::E_MOTOR_ENCODER_DEGREES); // Right Back Top Wheel Motor
pros::Motor Right_Back_Bottom_Wheel(RBBWM_PORT, pros::E_MOTOR_GEARSET_18, true, pros::E_MOTOR_ENCODER_DEGREES); // Right Back Bottom Wheel Motor
...
// Expansion Motor
//pros::Motor Expansion(2, pros::E_MOTOR_GEARSET_18, true, pros::E_MOTOR_ENCODER_DEGREES);
